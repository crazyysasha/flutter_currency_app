...
mixin _$Currency {
  ...
  @JsonKey(name: "conversion_rates", fromJson: Currency.rateFromJson)
...
abstract class $CurrencyCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: "base_code") String code,
      @JsonKey(name: "conversion_rates", fromJson: Currency.rateFromJson)
      List<Rate> rates});
}
...
class _$CurrencyImpl implements _Currency {
  const _$CurrencyImpl(
      {@JsonKey(name: "base_code") required this.code,
      @JsonKey(name: "conversion_rates", fromJson: Currency.rateFromJson)
  ...
  @override
  String toString() {
    return 'Currency(code: $code, rates: $rates)';
  }
...
abstract class _Currency implements Currency {
  const factory _Currency(
      {@JsonKey(name: "base_code") required final String code,
      @JsonKey(name: "conversion_rates", fromJson: Currency.rateFromJson)
      required final List<Rate> rates}) = _$CurrencyImpl;
